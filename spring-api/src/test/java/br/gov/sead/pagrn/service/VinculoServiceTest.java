...
class VinculoServiceTest {
    ...
    private void getNomeacao(TipoVinculo tipoVinculo, Nomeacao nomeacao) {
        nomeacao.setServidor(new Servidor());
        nomeacao.setUnidadeOrganizacional(new UnidadeOrganizacional());
        nomeacao.setSetor(new Setor());
        nomeacao.setTipoVinculo(tipoVinculo);
        nomeacao.setRegimeJuridico(RegimeJuridico.CLT);
        nomeacao.setDataNomeacao(LocalDate.now());
        nomeacao.setDataPosse(LocalDate.now());
        nomeacao.setDataInicioExercicio(LocalDate.now());
        nomeacao.setNivelCargo(new NivelCargo());
        nomeacao.setFuncao(new Funcao());
    }
    ...
    void testVinculoEfetivoEmDisposicaoEAproveitamento(TipoVinculo tipoVinculo) {
        ...
        aproveitamento.setNivelCargo(new NivelCargo());
